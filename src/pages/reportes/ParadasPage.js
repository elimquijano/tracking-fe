...
import { columnsReportTraccarParadas } from "../../utils/ExportColumns";
...
const columns = [
  ...
  { id: "endOdometer", label: "ODOMETRO FINAL", minWidth: 170, key: 4 },
  { id: "address", label: "DIRECCION", minWidth: 170, key: 5 },
  { id: "duration", label: "DURACION", minWidth: 170, key: 6 },
  { id: "engineHours", label: "HORAS DE MOTOR", minWidth: 170, key: 7 },
  { id: "spendFuel", label: "COMBUSTIBLE GASTADO", minWidth: 170, key: 8 },
];
...
export default function ParadasPage() {
  ...
  const ExportFilter = async () => {
    try {
      ...
      exportToExcel(dataParse, columnsReportTraccarParadas, "Paradas");
    } catch (error) {
